                ...
                <div className="GameSettings">
                    ...
                    <div className="rounds">
                        ...
                        <ul>
                            ...
                            <li>
                                <Button onClick={() => this.setRounds(2)} value="2" />
                            </li>
                            <li>
                                <Button onClick={() => this.setRounds(3)} value="3" />
                            </li>
                            <li>
                                <Button onClick={() => this.setRounds(4)} value="4" />
                            </li>
                            ...
                            <li>
                                <Button onClick={() => this.setRounds(6)} value="6" />
                            </li>
                            <li>
                                <Button onClick={() => this.setRounds(7)} value="7" />
                            </li>
                            <li>
                                <Button onClick={() => this.setRounds(8)} value="8" />
                            </li>
                            <li>
                                <Button onClick={() => this.setRounds(9)} value="9" />
                            </li>
                            <li>
                                <Button onClick={() => this.setRounds(10)} value="10" />
                            </li>
                        </ul>
                    </div>
                    <div className="players">
                        <div>
                            <h1>Player 1: </h1>
                            <input type="text" placeholder="Player 1 Name..." className="inputNickname" onChange={(e) => this.setState({ inputP1: e.target.value, nicknameP1: e.target.value })} value={this.state.inputP1} />
                        </div>

                        <div>
                            <h1>Player 2: </h1>
                            <input type="text" placeholder="Player 2 Name..." className="inputNickname" onChange={(e) => this.setState({ inputP2: e.target.value, nicknameP2: e.target.value })} value={this.state.inputP2} />
                        </div>
                    </div>
                    <div>
